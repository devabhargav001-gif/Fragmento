...
homeBtn.addEventListener("click", function () {
    sessionStorage.setItem("fragmento-screen", "hero");
...
startbtn.addEventListener("click", function () {
    sessionStorage.setItem("fragmento-screen", "workspace");
...
// refresh wala bug (sessionStorage se check karega)
const currentScreen = sessionStorage.getItem("fragmento-screen");
...
organizebtn.addEventListener("click", function (event) {
    ...
    lines.forEach(function (line) {
        ...
        const taskKeywords = [
            "buy", "book", "call", "gym", "go", "visit", "meet", 
            "submit", "finish", "complete", "renew", "travel", 
            "ticket", "passport", "jana", "lena", "karna"
        ];

        const ideaKeywords = [
            "learn", "think", "idea", "build", "create", "design", 
            "improve", "react", "backend", "sikhna", "project", "ai"
        ];

        const questionKeywords = [
            "?", "how", "what", "why", "when", "where", "which", 
            "should", "can", "kya", "kaise", "kyu", "kab"
        ];
